...
""" Profit to make $100 per transaction """
    ...
    for index in range(len(ROWSOFSTOCKINF) - 2, 1, -1):
        ...
        if stockHold =0:
            numberOfStocksByExecutePrice = (cash) / executePrice
           targetPrice = (cash -100) / numberOfStocksByExecutePrice
            if targetPrice < toDayHighPrice and  targetPrice > toDaylowPrice  :
                # do my buy
